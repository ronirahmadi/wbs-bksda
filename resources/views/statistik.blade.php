...
<div class="single">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">	
                <p>
                    Laporan yang masuk melalui aplikasi WBS internal BKSDA akan ditindak lanjuti selambat-lambatnya 7 (tujuh) hari kerja terhitung sejak laporan diterima. Terdapat 4 (empat) jenis pelanggaran melalui WBS internal BKSDA yaitu :
                </p>
                <ul class="list-group">
                    <li class="list-group-item">1. <strong>Penyimpangan dari tugas dan fungsi.</strong></li>
                    <li class="list-group-item">2. <strong>Gratifikasi atau suap.</strong></li>
                    <li class="list-group-item">3. <strong>Benturan kepentingan</strong></li>
                    <li class="list-group-item">4. <strong>Melanggar peraturan dan perundangan yang berlaku.</strong></li>
                </ul>
