      ...
      <form method="GET" action="/pantau">
        <div class="inner-form">
          ...
          <div class="row third">
            <div class="input-field">
              <div class="group-btn">
                <button class="btn-delete" href="{{ route('pantau') }}">RESET</button>
          ...
          <div class="single">
                <div class="container">
                    <div class="section-header">
                        ...
                        <h2 style="font-weight:bold">{{ $laporan->judul }}</h2>
                    </div>
                    <div class="row">
                        <div class="col-12">
                          <ul class="list-group">
                              <li class="list-group-item">Nama Pelapor : {{ $laporan->namapelapor }}</li>
                              <li class="list-group-item">Kode Unik : {{ $laporan->kodeunik }}</li>
