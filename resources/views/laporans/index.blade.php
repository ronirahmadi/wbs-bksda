				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{ Route('laporans.index') }}">Belum Diverifikasi</a>
							</li>
						</ul>
					</div>
					<div class="row">
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															...
															<button class="btn btn-link btn-primary btn-lg"><a class="fa fa-edit" href="{{ route('laporans.edit',$laporan->id) }}"> Edit</a></button>
															<!-- sementara dihilangkan perencanaan super admin
